...
function sumFavorablility(startLevel: number, endLevel: number) {
    let sum = 0;
...
export function calculate_numer(startLevel: number, endLevel: number) {
...
// 计算好感度需求
export function favorCalculate(startLevel, endLevel) {
