...
exports.guide_systeam = exports.FMPS_server_list = exports.FMPS_server_download = exports.alincloud = exports.synonyms = exports.maxmap_sms = exports.guideConfig = exports.guide_qq = exports.inject = void 0;
//import区域
...
exports.guide_qq = koishi_1.Schema.intersect([
    koishi_1.Schema.object({
        markdown_setting: koishi_1.Schema.object({
            mdid: koishi_1.Schema.string().description('qqbot MD模板id'),
            mdp1: koishi_1.Schema.string().default('text1').description('MD参数--1'),
            mdp2: koishi_1.Schema.string().default('text2').description('MD参数--2'),
            mdp3: koishi_1.Schema.string().default("img").description('MD参数--3'),
            mdp4: koishi_1.Schema.string().default("url").description('MD参数--4'),
            Bucketname: koishi_1.Schema.string().description('[存储桶](https://cloud.tencent.com/document/product/436)名称'),
            Region: koishi_1.Schema.string().description('所在区域'),
            SecretId: koishi_1.Schema.string().role('secret').description('账户[SecretId](https://console.cloud.tencent.com/cam/capi)'),
            SecretKey: koishi_1.Schema.string().role('secret').description('账户[SecretKey](https://console.cloud.tencent.com/cam/capi)'),
        }).collapse(),
    }).description('QQ官方bot设置,暂时使用tx的对象存储来发送md图片'),
]);
exports.guideConfig = koishi_1.Schema.intersect([
    koishi_1.Schema.object({
        avatar: koishi_1.Schema.boolean().description('模糊匹配时生成学生头像图（canvas）'),
        ...
        return: koishi_1.Schema.string().default('呜呜，没有匹配到结果,sensei要找的是这些吗？输入序号查看:').description('模糊匹配的回复文本'),
        returnmd: koishi_1.Schema.string().default('sensei久等啦，这是爱丽丝找到的攻略内容').description('Markdown模板模糊匹配的回复文本'),
        timeout_text: koishi_1.Schema.string().default('呜呜，等待超时，请重新触发指令').description('超时回复文本')
    }).description('攻略系统设置'),
]);
exports.maxmap_sms = 25;
exports.synonyms = {
...
exports.FMPS_server_download = 'http://124.221.198.113:9123/download/data/';
exports.FMPS_server_list = 'http://124.221.198.113:9123/download/';
exports.guide_systeam = ({
    async apply(ctx, config) {
        ...
        async function initialisation_locally_generated() {
            ...
            const tarodata = `${exports.FMPS_server_download}sanae_match/Sanae_match_to_arona_data.json`;
        ...
        async function updcos(object_name_key, img) {
            try {
...
攻略图来自arona.diyigemt`);
                ...
                const match_data = await (0, match_1.MatchArona)(message);
                ...
                if (match_data.length == 2) {
                    ...
                    if (mdswitch) {
                        ...
                        const md = markdow_fuzzy(session, cosurl, match_data[1], match_data[2], match_data[3], match_data[4], match_data[5], match_data[6]);
                        try {
