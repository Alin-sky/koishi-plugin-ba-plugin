...
function apply(ctx) {
    ctx.command("总力", '凹ba总力战')
        ...
        for (let oo of jilu)
            if ((args[0]) === oo) {
                if (latest.length > 0) {
                    //进行合并转发测试的模块
                    return (exports.jsx_runtime_1.jsx)("message", { forward: true, children: (exports.jsx_runtime_1.jsxs)("message", { children: [(exports.jsx_runtime_1.jsx)("author", { "user-id": session.selfId }),
                                (exports.jsx_runtime_1.jsx)("p", { children: latest })] }) });
                }
                else {
                    return "啊嘞？战斗记录找不到了......";
                }
    ...
    ctx.command("千里眼", '国急服千里眼')
        .usage('国急服，急急急急急急急急急')
        .action(() => {
        return ((0, koishi_1.h)('image', { url: ((0, url_1.pathToFileURL)((0, path_1.resolve)(__dirname + '/data/photo1/n2.jpg'))) }));
    });
    ctx.command("礼物", '学生礼物查询')
        .action(() => {
        return ((0, koishi_1.h)('image', { url: ((0, url_1.pathToFileURL)((0, path_1.resolve)(__dirname + '/data/photo1/n1.jpg'))) }));
    });
}
exports.apply = apply;
