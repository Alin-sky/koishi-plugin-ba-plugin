...
exports.apply = exports.inup = exports.jaup = exports.schema = exports.usage = exports.name = void 0;
...
exports.schema = koishi_1.Schema.object({
    server: koishi_1.Schema.number().default(1).description('图源服务器（1-3）'),
    JApersona: koishi_1.Schema.string().default('南').description('日服UP池角色'),
    INpersona: koishi_1.Schema.string().default("时雨").description('国急服UP池角色'),
});
//服务器
