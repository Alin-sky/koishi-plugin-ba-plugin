...
export class Stars {
  ...
  constructor(stars: number, status: { [key: number]: number[] }, basic_stars: number = 3) {
    this.stars = stars;
    this.status = status;
...
export class Equipment{
  ...
  constructor(form: string, level: number, status: { [key: string]: any }) {
    this.form = form;
    this.level = level;
    this.status = status;
  }
...
export class Exclusive_weapon{
  level: number;
  status: { [key: string]: any };
  skill_plus: { [key: string]: any };
  adaption_plus: { [key: string]: string };

  constructor(level: number, status: { [key: string]: any }, skill_plus: { [key: string]: any },
    adaption_plus: { [key: string]: string }) {
    this.level = level
    this.status = status;
